...
func.func @kenerl(%arg0: tensor<1x40x4096xf32>, %arg1: tensor<4096xf32>, %arg2: tensor<11008x4096xf32>) {
    ...
    %tensor_unranked = tensor.cast %146 : tensor<1x40x11008xf32> to tensor<*xf32>
...
func.func @main() {
    ...
    %c1 = arith.constant dense<1.0> : tensor<4096xf32>
    %c2 = arith.constant dense<2.0> : tensor<11008x4096xf32>
    %c3 = arith.constant dense<3.0> : tensor<11008x4096xf32>
    %c4 = arith.constant dense<4.0> : tensor<4096x11008xf32>

    call @kenerl(%c05, %c1, %c2) : (tensor<1x40x4096xf32>, tensor<4096xf32>, tensor<11008x4096xf32>) -> ()
