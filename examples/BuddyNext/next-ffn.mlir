...
func.func @kenerl(%arg0: tensor<1x40x4096xf32>, %arg1: tensor<4096xf32>, %arg2: tensor<11008x4096xf32>, %arg3: tensor<11008x4096xf32>, %arg4: tensor<4096x11008xf32>) {
    %t_start = call @rtclock() : () -> f64

    %128 = tensor.empty() : tensor<1x40x4096xf32>
    %c2_i32_23 = arith.constant 2 : i32
    %129 = linalg.generic {indexing_maps = [#map5, #map5], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg0 : tensor<1x40x4096xf32>) outs(%128 : tensor<1x40x4096xf32>) {
    ^bb0(%in: f32, %out: f32):
    ...
    %137 = tosa.mul %arg0, %136 {shift = 0 : i8} : (tensor<1x40x4096xf32>, tensor<1x40x1xf32>) -> tensor<1x40x4096xf32>
    %138 = tosa.reshape %arg1 {new_shape = array<i64: 1, 1, 4096>} : (tensor<4096xf32>) -> tensor<1x1x4096xf32>
    ...
    %141 = tosa.transpose %arg2, %140 : (tensor<11008x4096xf32>, tensor<2xi32>) -> tensor<4096x11008xf32>
...
func.func @main() {
    ...
    %c1 = arith.constant dense<0.1> : tensor<4096xf32>
    %c2 = arith.constant dense<0.2> : tensor<11008x4096xf32>
    %c3 = arith.constant dense<0.3> : tensor<11008x4096xf32>
    %c4 = arith.constant dense<0.4> : tensor<4096x11008xf32>

    call @kenerl(%c05, %c1, %c2, %c3, %c4) : (tensor<1x40x4096xf32>, tensor<4096xf32>, tensor<11008x4096xf32>, tensor<11008x4096xf32>, tensor<4096x11008xf32>) -> ()
